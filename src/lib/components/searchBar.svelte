...
<div class="search-bar w-full flex h-full">
<input class="py-5 text-xl w-3/4" type="text" placeholder={data.placeholder} bind:value={searchTerm}>
<a class="search-icon w-1/4 h-full" href='/search/{searchTerm}/1'>
